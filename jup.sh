...
dir_root=$dir_shell
url_shell=${JD_SHELL_URL:-https://ghproxy.com/https://github.com/msechen/jdv5.git}
url_scripts=${JD_SCRIPTS_URL:-https://ghproxy.com/https://github.com/msechen/scrips.git}
